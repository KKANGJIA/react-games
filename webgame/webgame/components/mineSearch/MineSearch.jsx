...
// createContext 함수를 실행시키면서 context API 사용하기(import하기)
//초깃값을 작성해준다
...
const MineSearch = () => {
  ...
  return (
    //context API로 다른 곳에서도 데이터를 사용하려면 TableContext.Provider로 감싸줘야한다
    //자식 컴포넌트에서 데이터에 접근하기 위한 데이터는 value에다가 넣어준다
